...
OmegaConf.register_new_resolver("add", lambda *vals: sum(vals), replace=True)
OmegaConf.register_new_resolver("subtract", lambda *vals: vals[0] - sum(vals[1:]), replace=True)
